...
//app.io.lightControl = require('./public/js/lights/lightControl.js')(app.io);
//app.io.alarmActivated = require('./public/js/security/alarmActivated.js')(app.io);
//app.io.videoStream = require('./public/js/video/videoStream.js')(app, app.io);
